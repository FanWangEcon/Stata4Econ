...
% Titling and Author
\title{Table Six Columns and Three Panel with Continuous Interactions with One Discrete}
...
Regression with multiple continuous variables and one discrete variable.

Interact the continuous variables with the discrete variable.

\input{tab_6col_cts_inter_texbody}
