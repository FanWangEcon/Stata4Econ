...
Regression with continous varible and discrete variables, discrete variables could interact with each other, and interact with continuous variable. Patient ID is thee continuous variable. Includes binary and 3 category discrete variables here. 
